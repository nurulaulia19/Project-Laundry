            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('transaksi.storeTransaksi') }}">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" placeholder="Tanggal Terima" name="tanggal_transaksi" id="tanggal_transaksi" class="form-control">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" placeholder="Tanggal Selesai" name="tanggal_selesai" id="tanggal_selesai" class="form-control" required>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="customerSearch" class="form-control" placeholder="Cari customer..." autocomplete="off" required>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="cabangSearch" class="form-control" placeholder="Cari cabang..." autocomplete="off" required>
                    ...
                    <div class="form-group d-flex mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Diskon" name="diskon_transaksi" id="diskon_transaksi" class="form-control" onblur="setDefaultDiskon()" value="0">
...
{{-- <script>
    ...
    function showNotFoundMessage(inputElement, notFoundElement) {
    ...
    customerSearchInput.addEventListener('input', function () {
        showNotFoundMessage(this, customerNotFound);
    });
    ...
    cabangSearchInput.addEventListener('input', function () {
        showNotFoundMessage(this, cabangNotFound);
    });
</script> --}}
...
{{-- <script>
 const setupSelectWithSearch = (inputId, selectId, options) => {
    ...
    const select = document.getElementById(selectId);
    const selectOptions = select.getElementsByTagName('option');
    const notFoundElement = document.getElementById(`${inputId}NotFound`);
    ...
    document.addEventListener('click', function(event) {
        if (!event.target.closest(`#${inputId}`) && !event.target.closest(`#${selectId}`)) {
            input.value = ''; // Menghapus isi input pencarian
            select.style.display = 'none';
            notFoundElement.style.display = 'none'; // Menyembunyikan pesan "Pencarian tidak ditemukan"
        }
    });

    

    // Event listener untuk menghapus pesan "Pencarian tidak ditemukan" ketika inputan berubah
    input.addEventListener('input', function() {
        notFoundElement.style.display = 'none';
    });
};
