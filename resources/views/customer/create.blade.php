					    ...
					    <div class="row">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Tambah Customer</h3>
                                </div>
                                ...
                                <form method="POST" action="/customer/store">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group d-flex mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="Nama Customer" name="nama_customer" id="nama_customer" class="form-control">
                                        ...
                                        <div class="form-group d-flex mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="Alamat Customer" name="alamat_customer" id="alamat_customer" class="form-control">
                                                <span id="alamat_customerError" class="error-message"></span>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex mb-3">
                                            <label class="col-sm-3 control-label" for="noHp_customer">No HP Customer</label>
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="No HP Customer" name="noHp_customer" id="noHp_customer" class="form-control">
