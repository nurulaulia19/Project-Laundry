                            ...
                            <div class="panel">
                                ...
                                <form method="POST" action="/produk/store" enctype="multipart/form-data">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group d-flex mb-3">
                                            <label class="col-sm-3 control-label" for="nama_produk">Jenis Layanan</label>
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="Jenis Layanan" name="nama_produk" id="nama_produk" class="form-control">
                                                <span id="produkError" class="error-message"></span>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex mb-3">
                                            <label class="col-sm-3 control-label" for="harga_produk">Harga per Kg</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group d-flex mb-3">
                                            <label class="col-sm-3 control-label" for="gambar_produk">Gambar</label>
                                            <div class="col-sm-9">
